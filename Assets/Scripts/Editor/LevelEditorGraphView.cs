...
namespace MadPot
{
    public class LevelEditorGraphView : GraphView
    {
        ...
        public LevelEditorGraphView(LevelInformation level)
        {
            styleSheets.Add(Resources.Load<StyleSheet>("LevelEditorGraph"));
            ...
            this.AddManipulator(new LevelManipulator(level));
